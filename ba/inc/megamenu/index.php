...
function add_js_mega_menu(){
    wp_enqueue_script( 'set_background', BA_TEMPLATE_URL . '/inc/megamenu/js/set_background.js', array( 'jquery', 'jquery-ui-sortable' ), false, true );
    wp_enqueue_media();
    add_thickbox();
}
        ...
        <div class="menu-item-settings" id="menu-item-settings-<?php echo esc_attr( $item_id ); ?>">
			...
			if ( ! $depth ) {
				...
				<p class="description description-thin">
					...
					<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
						<select id="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( $key . "[" . $item_id . "]" ); ?>">
							<option value="standard" <?php echo ( $value == 'standard' ) ? ' selected="selected" ' : ''; ?>>Standard</option>
							<option value="columns1" <?php echo ( $value == 'columns1' ) ? ' selected="selected" ' : ''; ?>>1 Column</option>
							<option value="columns2" <?php echo ( $value == 'columns2' ) ? ' selected="selected" ' : ''; ?>>2 Columns</option>
							<option value="columns3" <?php echo ( $value == 'columns3' ) ? ' selected="selected" ' : ''; ?>>3 Columns</option>
							<option value="columns4" <?php echo ( $value == 'columns4' ) ? ' selected="selected" ' : ''; ?>>4 Columns</option>
							<option value="columns5" <?php echo ( $value == 'columns5' ) ? ' selected="selected" ' : ''; ?>>5 Columns</option>
						</select>
					</label>
				</p>
				<?php
				...
				<p class="description description-thin">
					...
					<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
						<select id="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( $key . "[" . $item_id . "]" ); ?>">
							<option value="algleft" <?php echo ( $value == 'algleft' ) ? ' selected="selected" ' : ''; ?>>Alignleft</option>
							<option value="algright" <?php echo ( $value == 'algright' ) ? ' selected="selected" ' : ''; ?>>Alignright</option>
							<option value="algcenter" <?php echo ( $value == 'algcenter' ) ? ' selected="selected" ' : ''; ?>>Aligncenter</option>
						</select>
					</label>
				</p>
				<?php
			...
			<p class="description description-thin"<?php echo esc_attr( $style ); ?>>
				...
				<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
					<select id="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( $key . "[" . $item_id . "]" ); ?>">
						<option value="" <?php echo ( $value == '' ) ? ' selected="selected" ' : ''; ?>>Select Widget Area</option>
						<?php
			...
			<p class="description description-thin">
				...
				<label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
					<select id="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( $key . "[" . $item_id . "]" ); ?>">
						<option value="0" <?php echo ( $value == '0' ) ? ' selected="selected" ' : ''; ?>>No</option>
						<option value="1" <?php echo ( $value == '1' ) ? ' selected="selected" ' : ''; ?>>Yes</option>
					</select>
				</label>
			</p>
		<?php }
        ...
        <p class="description description-thin">
            ...
            <p class="description description-wide">
                <label for="edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>">
                    ...
                    <button id="browse-edit-<?php echo esc_attr( $key . '-' . $item_id ); ?>" class="set_custom_images button button-secondary submit-add-to-menu">Browse Image</button>
            ...
            <div class="menu-item-actions description-wide submitbox">
                ...
                ); ?>">Remove</a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo esc_attr( $item_id ); ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) ) ) );
